function [xo, yo, zo, Pt_ID] = gendata(a, e0)
xo = zeros(50, 1); yo = zeros(50, 1); zo = zeros(50, 1); Pt_ID = zeros(50, 1);
index = 1;
for i = 30:60:330
    for j = -70:20:70
        [xo(index), yo(index), zo(index)] = lph2xyz(i * (pi / 180), j * (pi / 180), 0, a, e0);
        Pt_ID(index) = index;
        index = index + 1;
    end
end
...
Pt_ID(49) = 49;
Pt_ID(50) = 50;
[xo(49), yo(49), zo(49)] = lph2xyz(0 * (pi / 180), 90 * (pi / 180), 0, a, e0);
[xo(50), yo(50), zo(50)] = lph2xyz(0 * (pi / 180), -90 * (pi / 180), 0, a, e0);
